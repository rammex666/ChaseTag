...
- **2026-05-24:** Modification de la méthode d'assignation des joueurs aux poules et matches de tournoi : remplacement de la sélection par clic sur tête par une saisie du pseudo dans le chat pour plus de précision et support des joueurs hors-ligne.
...
- **2026-05-26:** Suppression complète du système de whitelist : retrait des commandes Discord (`/wl`, `/wllist`), suppression de la vérification à la connexion dans le Lobby et nettoyage de la configuration.
